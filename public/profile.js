var Profile = {
    render() {
        ...
        <div class="pt-6 px-4 text-center">
            ...
            <h1 class="text-3xl font-black chrome-text mb-1">DooMusify</h1>
            ...
            <div class="glass rounded-2xl p-5 max-w-sm mx-auto space-y-3 text-left mb-6">
                ...
                <div class="flex justify-between"><span class="text-white/70 text-sm">Nama</span><span class="text-white font-medium text-sm">DooMusify</span></div>
